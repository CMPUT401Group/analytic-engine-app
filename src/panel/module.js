...
ExampleAppPanelCtrl.template = '<h2 class="analytic-engine-app-heading"></h2>' +
  ...
  '  <ol class="card-list" >' +
  '    <metric-entry name="metric1" correlation="69"></metric-entry>' +
  '    <metric-entry name="metric2" correlation="69"></metric-entry>' +
  '    <metric-entry name="metric3" correlation="69"></metric-entry>' +
  '    <metric-entry name="metric4" correlation="69"></metric-entry>' +
  '  </ol>' +
  '</div>';
