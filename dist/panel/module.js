...
System.register(['app/plugins/sdk', '../css/example-app.css!', '../directives/metric-entry'], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      ExampleAppPanelCtrl.template = '<h2 class="analytic-engine-app-heading"></h2>' + '<div class="card-section card-list-layout-list" layout-mode>' + '  <ol class="card-list" >' + '    <metric-entry name="metric1" correlation="69"></metric-entry>' + '    <metric-entry name="metric2" correlation="69"></metric-entry>' + '    <metric-entry name="metric3" correlation="69"></metric-entry>' + '    <metric-entry name="metric4" correlation="69"></metric-entry>' + '  </ol>' + '</div>';
